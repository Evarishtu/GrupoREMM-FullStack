...
let usuarios = [
    {
        nombre: 'Evarishtu Dongua Kuzin',
        email: 'edongua@uoc.edu',
        password: 'ABCD1234'
    },
      {
        nombre: 'Marc Espuga Moreno',
        email: 'mespugam@uoc.edu',
        password: '4321DCBA'
    },
    {
        nombre: 'Meritxell Mosquera van den Bergh',
        email: 'mmosquerava@uoc.edu',
        password: '5678ZXWV'
    },
      {
        nombre: 'Roque Carrillo Martínez',
        email: 'rcarrillomar@uoc.edu',
        password: 'ZXWV5678'
    }
];
